...
@Service
public class EpicSearchService {

    private final TargetProcessProperties properties;
    private final TargetProcessHttpClient httpClient;
    private final EpicConverter converter;

    public EpicSearchService(TargetProcessProperties properties,
    ...
    public List<EpicDto> searchEpics(String nameQuery, String projectName,
        ...
        TargetProcessResponse<Epic> resp = httpClient.parse(body, new TypeReference<>() {});

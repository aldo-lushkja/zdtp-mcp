...
public class TestPlanSearchService extends BaseService {
    ...
    public TestPlanSearchService(QueryEngine engine, TestPlanConverter converter) {
        super(engine);
    ...
    public List<TestPlanDto> searchTestPlans(String nameQuery, String projectName, String ownerLogin, String startDate, String endDate, int take) {
        return search(new SearchCriteria(nameQuery, projectName, ownerLogin, startDate, endDate, take, null));
    }
    ...
    public List<TestPlanDto> search(SearchCriteria criteria) {
        ...
        return engine.list(QueryEngine.TEST_PLAN, parameters, new TypeReference<>() {}, converter::toDto);
    }
}

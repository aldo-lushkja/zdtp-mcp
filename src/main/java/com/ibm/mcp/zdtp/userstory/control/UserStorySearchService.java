...
public class UserStorySearchService extends BaseService {
    ...
    public UserStorySearchService(TargetProcessProperties properties, TargetProcessHttpClient httpClient, UserStoryConverter converter) {
    ...
    public List<UserStoryDto> search(SearchCriteria criteria) {
        ...
        return fetchList("UserStories", parameters, new TypeReference<>() {}, converter::toDto);
    }
}

...
public class TeamIterationSearchService extends BaseService {
    ...
    public TeamIterationSearchService(TargetProcessProperties properties, TargetProcessHttpClient httpClient, TeamIterationConverter converter) {
    ...
    public List<TeamIterationDto> search(SearchCriteria criteria) {
        ...
        parameters.put("include", "[Id,Name,StartDate,EndDate,Team[Id,Name]]");
        parameters.put("orderByDesc", "StartDate");
        parameters.put("take", String.valueOf(criteria.take()));

        return fetchList("TeamIterations", parameters, new TypeReference<>() {}, converter::toDto);
    }
}

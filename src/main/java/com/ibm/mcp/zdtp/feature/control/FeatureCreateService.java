...
public class FeatureCreateService extends BaseService {
    ...
    public FeatureCreateService(TargetProcessProperties properties, TargetProcessHttpClient httpClient, FeatureConverter converter, ObjectMapper objectMapper) {
    ...
    public FeatureDto create(String name, int projectId, String description, Double effort) {
        try {
            ...
            return postSingle("Features", parameters, jsonBody, Feature.class, converter::toDto);
        } catch (Exception e) {

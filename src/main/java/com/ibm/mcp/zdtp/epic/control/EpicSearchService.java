...
public class EpicSearchService extends BaseService {
    ...
    public EpicSearchService(TargetProcessProperties props, TargetProcessHttpClient http, EpicConverter conv, ObjectMapper mapper) {
    ...
    public List<EpicDto> search(SearchCriteria criteria) {
        ...
        return engine.list(QueryEngine.EPIC, p, new TypeReference<>() {}, converter::toDto);
    }
}
